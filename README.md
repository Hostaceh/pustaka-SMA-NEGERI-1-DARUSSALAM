                ...
                <div class="p-4 h-40 relative" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(248, 250, 252, 0.95) 100%);">
                    ...
                    <div class="flex h-full relative z-10">
                        ...
                        <div class="flex-1 pr-3">
                            ...
                            <div class="mb-2">
                                <p class="text-xs text-gray-600 uppercase tracking-wide">NIK</p>
                                <p id="memberNik" class="font-mono text-sm text-gray-800">-</p>
                            </div>
                            <div class="mb-2">
    ...
    <script>
            ...
            try {
                ...
                if (membersData.length > 0) {
                    ...
                    if (userType === 'siswa') {
                        ...
                        const studentNik = membersData[0].NIK || membersData[0].nik || 'NIK tidak tersedia';
                        document.getElementById('studentCardInfo').textContent = `${studentName} - ${studentNik}`;
                    }
                }
            } catch (error) {
        ...
        function populateSelect() {
            ...
            membersData.forEach((member, index) => {
                ...
                option.value = index;
                option.textContent = `${member.Nama || member.Name || 'Nama tidak tersedia'} - ${member.NIK || member.nik || 'NIK tidak tersedia'}`;
        ...
        function populateTable() {
            ...
            membersData.forEach(member => {
                ...
                const nik = member.NIK || member.nik || 'N/A';
                ...
                if (userType === 'siswa') {
                    ...
                    row.innerHTML = `
                        <td class="px-4 py-3 text-sm text-gray-900">${name}</td>
                        <td class="px-4 py-3 text-sm font-mono text-gray-900">${nik}</td>
        ...
        function updateCard(member) {
            ...
            const nik = member.NIK || member.nik || 'NIK tidak tersedia';
            const kelas = member.Kelas || member.Class || member.Grade || 'Kelas tidak tersedia';
            
            document.getElementById('memberName').textContent = name;
            document.getElementById('memberNik').textContent = nik;
        ...
        async function createCardElement(member) {
                ...
                <div class="card-body-print" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(248, 250, 252, 0.95) 100%); position: relative;">
                    ...
                    <div style="display: flex; height: 100%; position: relative; z-index: 10;">
                        <div style="flex: 1; padding-right: 12px;">
                            ...
                            <div style="margin-bottom: 8px;">
                                <p style="font-size: 10px; color: #4b5563; text-transform: uppercase; letter-spacing: 0.05em; margin: 0;">NIK</p>
                                <p style="font-family: monospace; font-size: 14px; color: #1f2937; margin: 2px 0 0 0;">${member.NIK || member.nik || '-'}</p>
                            </div>
                            <div style="margin-bottom: 8px;">
            ...
            const memberNik = member.NIK || member.nik || '000000';
            
            JsBarcode(tempBarcodeElement, memberNik, {
                format: "CODE128",
                width: 1.5,
                height: 40,
                displayValue: false,
        ...
        document.getElementById('printBtn').addEventListener('click', async function() {
            ...
            const name = member.Nama || member.Name || 'Nama tidak tersedia';
            const memberNik = member.NIK || member.nik || 'NIK tidak tersedia';
            ...
            try {
                ...
                // Log print activity
                await logPrintActivity(name, memberNik, 'single');
            ...
            try {
                ...
                for (let i = 0; i < membersData.length; i++) {
                    ...
                    printedMembers.push({
                        ...
                        nik: member.NIK || member.nik || 'NIK tidak tersedia'
                    });
                ...
                for (const member of printedMembers) {
                    await logPrintActivity(member.name, member.nik, 'batch');
                }
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'97e547a3413ffe1d',t:'MTc1Nzc0MTcxMi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
